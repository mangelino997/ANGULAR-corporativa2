...
@Component({
  selector: 'app-orthopantomography-gif',
  templateUrl: './orthopantomography-gif.component.html',
  styleUrls: ['./orthopantomography-gif.component.scss']
})
export class OrthopantomographyGifComponent implements OnInit {
  //Define el formulario
  public gifForm:FormGroup;
  //Define la lista de tipos de analisis
  public typesAnalysis:Array<any> = [];
  //Constructor
  constructor(private toast: ToastrService, private aoImageGifService: AoImageGifService) {
...
public save(){
  this.aoImageGifService.add(this.gifForm.get('image').value).subscribe(res=>{
